...
#         last_day = calendar.monthrange(iy, imo)[1]
        
#         start_date = f"{iy}-{imo:02d}-01T00:00:00"
#         end_date = f"{iy}-{imo:02d}-{last_day:02d}T23:59:59"
#         output_filename = f"{output_directory}/U_{iy}_{imo:02d}_m.nc"
...
def download_month(year, month):
    try:
        ...
        output_filename = f"{output_directory}/U_{year}_{month:02d}_m.nc"
...
MAX_THREADS = 6  # o el número de CPUs que SLURM te da
