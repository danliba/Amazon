...
cd /work/bk1450/b383184/Amazon/Mercator/notebooks/Analysis/kmeans_analysis/kmeans_50_100days/notebooks
mkdir -p executed
...
# --- choices (edit these) ---------------------------------------------------
BEST_K=30                    # k carried into stages 3 & 4 (inspect 02 first)
