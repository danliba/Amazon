...
cd /work/bk1450/b383184/Amazon/Mercator/notebooks/Analysis/kmeans_analysis/kmean_analysis_50_150_stdZ/notebooks
mkdir -p executed
...
# --- choices (edit these) ---------------------------------------------------
BEST_K=40                    # k carried into stages 3 & 4 (inspect 02 first)
