...
# Stage 01 (feature extraction) is NOT re-run: features.parquet is unchanged by
# the xyz/haversine switch (that only affects clustering in stage 02).
# ---------------------------------------------------------------------------
...
cd /work/bk1450/b383184/Amazon/Mercator/notebooks/Analysis/kmeans_analysis/kmeans_100_150days/notebooks
mkdir -p executed
...
# --- choices (edit these) ---------------------------------------------------
BEST_K=20                    # k carried into stages 3 & 4 (inspect 02 first)
